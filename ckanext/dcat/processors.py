...
class RDFSerializer(RDFProcessor):
    ...
    def graph_from_source_catalog(self, root_catalog_ref, dataset_dict, dataset_ref):
        ...
        source_uri = _get_from_extra('source_homepage')
        if not source_uri:
            return
        ...
        sources = (('source_title', DCT.title, Literal,),
                   ('source_description', DCT.description, Literal,),
                   ('source_homepage', FOAF.homepage, URIRef,),
                   ('source_language', DCT.language, Literal,),
                   ('source_modified', DCT.modified, Literal,),)
        ...
        _pub = _get_from_extra('source_publisher')
        if _pub:
            pub = json.loads(_pub)
